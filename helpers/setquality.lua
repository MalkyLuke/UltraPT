...
function Config.SetQuality()
	if Var.settings.quality == Var.quality.VANILLA then
	...
	if Var.settings.quality == Var.quality.FAST then
		Cyberpunk.SetOption('/graphics/advanced', 'GlobaIlluminationRange', '0')
	...
	if Var.settings.quality == Var.quality.MEDIUM or Var.settings.quality == Var.quality.AUTO then
		Cyberpunk.SetOption('/graphics/advanced', 'GlobaIlluminationRange', '0')
	...
	if Var.settings.quality == Var.quality.HIGH then
		...
		if Var.settings.mode == Var.mode.HYBRID or Var.settings.mode == Var.mode.PTNEXT then
			...
			Cyberpunk.SetOption('RayTracing/Reference', 'BounceNumberScreenshot', '0')
			Cyberpunk.SetOption('RayTracing/Collector', 'VisibilityFrustumOffset', '200.0')
			Cyberpunk.SetOption('Editor/RTXDI', 'NumInitialSamples', '24')
		...
		if Var.settings.mode == Var.mode.PT21 then
			...
			Cyberpunk.SetOption('RayTracing/Reference', 'BounceNumberScreenshot', '0')
			Cyberpunk.SetOption('RayTracing/Collector', 'VisibilityFrustumOffset', '200.0')
			Cyberpunk.SetOption('Editor/RTXDI', 'NumInitialSamples', '20')
